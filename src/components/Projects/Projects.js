                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <div className="work-box projects-article" augmented-ui="bl-clip r-clip-y br-round br-inset-clean exe">
                                <div className="work-img" >
                                    <img src="../../assets/images/Git-Sum-Dim-Sum.png" alt="" className="img-fluid" />
                                </div>
                                <div className="work-content">
                                    <div className="col-sm-12">
                                        <h2 className="w-title">Git Sum Dim Sum</h2>
                        ...
                        <div className="col-md-6">
                            <div className="work-box projects-article" augmented-ui="bl-clip r-clip-y br-round br-inset-clean exe">
                                ...
                                <div className="work-content">
                                    <div className="col-sm-12">
                                        <h2 className="w-title">Legal Eagles</h2>
                        ...
                        <div className="col-md-6">
                            <div className="work-box projects-article" augmented-ui="bl-clip r-clip-y br-round br-inset-clean exe">
                                ...
                                <div className="work-content">
                                    <div className="col-sm-12">
                                        <h2 className="w-title">Karuta!</h2>
