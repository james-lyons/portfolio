                ...
                <div className="wrap">
                    <div className="social-links">
                        ...
                        <div className="social-section-wrapper">
                            <div className="social-section-div"><a href="./files/Resume.docx"><i className="fa fa-file-pdf-o fa-3x social-icon" aria-hidden="true"></i><p className="social-p">Resume</p></a></div>
